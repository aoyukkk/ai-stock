...
class LLMUsage(IDMixin, TimestampMixin, ReprMixin, Base):
    ...
    call_id: Mapped[str | None] = mapped_column(String(128), unique=True)
    pipeline_run_id: Mapped[str | None] = mapped_column(String(128), index=True)
    validation_run_id: Mapped[str | None] = mapped_column(String(128), index=True)
    pro_resume_run_id: Mapped[str | None] = mapped_column(String(128), index=True)
