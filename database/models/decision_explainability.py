...
class FactorPerformanceHistory(IDMixin, TimestampMixin, ReprMixin, Base):
    ...
    positive_contribution_count: Mapped[int | None] = mapped_column()
    negative_contribution_count: Mapped[int | None] = mapped_column()
    mean_contribution: Mapped[Decimal | None] = mapped_column(SCORE)
    median_contribution: Mapped[Decimal | None] = mapped_column(SCORE)
    contribution_return_correlation: Mapped[Decimal | None] = mapped_column(SCORE)
    contribution_rank_ic: Mapped[Decimal | None] = mapped_column(SCORE)
    top_contribution_return: Mapped[Decimal | None] = mapped_column(SCORE)
    bottom_contribution_return: Mapped[Decimal | None] = mapped_column(SCORE)
    contribution_hit_rate: Mapped[Decimal | None] = mapped_column(SCORE)
    average_mfe: Mapped[Decimal | None] = mapped_column(SCORE)
    profit_factor: Mapped[Decimal | None] = mapped_column(SCORE)
    pass_contribution_json: Mapped[dict | None] = mapped_column(JSON)
    rank_contribution_json: Mapped[dict | None] = mapped_column(JSON)
