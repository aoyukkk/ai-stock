...
EDITABLE_CONFIG_SPECS: tuple[ConfigSpec, ...] = (
    ...
    _spec("selection_performance.minimum_recommendation_score", "review", ("selection_performance", "minimum_recommendation_score"), 60, "number", "selection_performance", "Minimum final review score for daily recommendations", {"min": 0, "max": 100}),
    ...
    _spec("selection_performance.default_selection_scope", "review", ("selection_performance", "default_selection_scope"), "FINAL_CANDIDATES", "string", "selection_performance", "Default selection scope", {"allowed_values": ["FINAL_CANDIDATES", "KEY_CANDIDATES", "LLM_ONLY", "MANUAL_ONLY", "BOTH_ONLY", "NON_ZERO_POSITION", "ALL_CANDIDATES_INCLUDING_ZERO_POSITION"]}),
